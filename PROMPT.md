...
Please use README.md, DESIGN.md existing folder and code infrastructure to update the code to match requirements for
this simple task management utility using .NET Core, SQLLite with EFCore, and React.

## Core Workflow

1. Review the docs.
2. Review the code already present.
3. Make alterations to the code to correct any data that doesn't match with the requirements and docs. a. Test that
   frontend/ runs and builds b. Test that backend/ runs and builds.
